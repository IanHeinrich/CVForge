...
class PrintingPlugin extends PrintingPlatform {
  ...
  Future<void> _initPlugin() async {
    ...
    if (!_hasPdfJsLib) {
      ...
      //
      // PATCHED (see third_party/printing/README.md): upstream's untyped
      // `getProperty(...)` here throws `TypeError: "...": type 'String' is
      // not a subtype of type 'Never'` for anyone who actually sets
      // dartPdfJsBaseUrl — https://github.com/DavBfr/dart_pdf/issues/1707.
