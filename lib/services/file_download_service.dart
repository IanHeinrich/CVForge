...
/// wrapping it here is the only way a test can assert that the PDF
/// exporter (P1.6) actually produced bytes and called the saver with the
/// right filename/mime type, rather than the mock just being the
/// singleton itself.
