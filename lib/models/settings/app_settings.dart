...
/// backup). [copilotProviderId]/[copilotModelId]/[rememberApiKey] have no
/// reader or setter yet — they exist now so the eventual Copilot feature
/// doesn't need a schema migration, the same bet `CvDraft` made on
/// `bulletOverrides` well before Phase 2 built its UI. The API key itself
/// is deliberately never a field here — it lives in its own storage row,
