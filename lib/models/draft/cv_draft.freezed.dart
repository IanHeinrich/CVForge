...
/// [Project] bullets instead of [Experience] bullets.
 Map<String, List<String>> get projectBulletIds; List<String> get skillIds; List<String> get educationIds; List<String> get hobbyIds; List<String> get languageIds; List<String> get publicationIds;/// Same shape and rationale as [bulletIds]/[projectBulletIds], one
...
/// over, for `CvVault.referencesNote`.
 String? get referencesOverride;/// Same null-means-inherit rationale as [tailoredSummary], for the
...
/// carry the translated sentence — the value is prose, not a code.
 String? get workAuthorizationOverride;/// Drops the work-authorization line from this draft, on exactly the
...
/// "kept in the Vault, printed only when it is relevant".
 bool get hideWorkAuthorization;/// educationId -> rewritten `Education.details` text. Same
...
/// [experienceLocationOverrides].
 ...
 Map<String, String> get hobbyOverrides;/// languageId -> rewritten `LanguageItem.name`. The proficiency has
/// no override: a CEFR band is a code, not wording, and reads the
/// same in every language.
 Map<String, String> get languageOverrides;/// educationId -> rewritten `Education.qualification`.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CvDraft&&(identical(other.schemaVersion, schemaVersion) || other.schemaVersion == schemaVersion)&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.templateId, templateId) || other.templateId == templateId)&&(identical(other.region, region) || other.region == region)&&(identical(other.documentLanguage, documentLanguage) || other.documentLanguage == documentLanguage)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other.experienceIds, experienceIds)&&const DeepCollectionEquality().equals(other.bulletIds, bulletIds)&&const DeepCollectionEquality().equals(other.projectIds, projectIds)&&const DeepCollectionEquality().equals(other.projectBulletIds, projectBulletIds)&&const DeepCollectionEquality().equals(other.skillIds, skillIds)&&const DeepCollectionEquality().equals(other.educationIds, educationIds)&&const DeepCollectionEquality().equals(other.hobbyIds, hobbyIds)&&const DeepCollectionEquality().equals(other.languageIds, languageIds)&&const DeepCollectionEquality().equals(other.publicationIds, publicationIds)&&const DeepCollectionEquality().equals(other.publicationBulletIds, publicationBulletIds)&&const DeepCollectionEquality().equals(other.publicationTitleOverrides, publicationTitleOverrides)&&const DeepCollectionEquality().equals(other.publicationCitationOverrides, publicationCitationOverrides)&&const DeepCollectionEquality().equals(other.educationBulletIds, educationBulletIds)&&const DeepCollectionEquality().equals(other.omittedFields, omittedFields)&&const DeepCollectionEquality().equals(other.hiddenSections, hiddenSections)&&const DeepCollectionEquality().equals(other.sectionOrder, sectionOrder)&&(identical(other.tailoredSummary, tailoredSummary) || other.tailoredSummary == tailoredSummary)&&const DeepCollectionEquality().equals(other.bulletOverrides, bulletOverrides)&&(identical(other.headlineOverride, headlineOverride) || other.headlineOverride == headlineOverride)&&(identical(other.hideHeadline, hideHeadline) || other.hideHeadline == hideHeadline)&&(identical(other.referencesOverride, referencesOverride) || other.referencesOverride == referencesOverride)&&(identical(other.workAuthorizationOverride, workAuthorizationOverride) || other.workAuthorizationOverride == workAuthorizationOverride)&&(identical(other.hideWorkAuthorization, hideWorkAuthorization) || other.hideWorkAuthorization == hideWorkAuthorization)&&const DeepCollectionEquality().equals(other.educationDetailsOverrides, educationDetailsOverrides)&&const DeepCollectionEquality().equals(other.roleOverrides, roleOverrides)&&const DeepCollectionEquality().equals(other.projectTitleOverrides, projectTitleOverrides)&&const DeepCollectionEquality().equals(other.experienceLocationOverrides, experienceLocationOverrides)&&const DeepCollectionEquality().equals(other.educationLocationOverrides, educationLocationOverrides)&&const DeepCollectionEquality().equals(other.skillLabelOverrides, skillLabelOverrides)&&const DeepCollectionEquality().equals(other.skillCategoryNameOverrides, skillCategoryNameOverrides)&&const DeepCollectionEquality().equals(other.hobbyOverrides, hobbyOverrides)&&const DeepCollectionEquality().equals(other.languageOverrides, languageOverrides)&&const DeepCollectionEquality().equals(other.educationQualificationOverrides, educationQualificationOverrides)&&const DeepCollectionEquality().equals(other.educationGradeOverrides, educationGradeOverrides)&&(identical(other.translatedTo, translatedTo) || other.translatedTo == translatedTo)&&(identical(other.targetJobDescription, targetJobDescription) || other.targetJobDescription == targetJobDescription)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,schemaVersion,id,name,templateId,region,documentLanguage,notes,const DeepCollectionEquality().hash(experienceIds),const DeepCollectionEquality().hash(bulletIds),const DeepCollectionEquality().hash(projectIds),const DeepCollectionEquality().hash(projectBulletIds),const DeepCollectionEquality().hash(skillIds),const DeepCollectionEquality().hash(educationIds),const DeepCollectionEquality().hash(hobbyIds),const DeepCollectionEquality().hash(languageIds),const DeepCollectionEquality().hash(publicationIds),const DeepCollectionEquality().hash(publicationBulletIds),const DeepCollectionEquality().hash(publicationTitleOverrides),const DeepCollectionEquality().hash(publicationCitationOverrides),const DeepCollectionEquality().hash(educationBulletIds),const DeepCollectionEquality().hash(omittedFields),const DeepCollectionEquality().hash(hiddenSections),const DeepCollectionEquality().hash(sectionOrder),tailoredSummary,const DeepCollectionEquality().hash(bulletOverrides),headlineOverride,hideHeadline,referencesOverride,workAuthorizationOverride,hideWorkAuthorization,const DeepCollectionEquality().hash(educationDetailsOverrides),const DeepCollectionEquality().hash(roleOverrides),const DeepCollectionEquality().hash(projectTitleOverrides),const DeepCollectionEquality().hash(experienceLocationOverrides),const DeepCollectionEquality().hash(educationLocationOverrides),const DeepCollectionEquality().hash(skillLabelOverrides),const DeepCollectionEquality().hash(skillCategoryNameOverrides),const DeepCollectionEquality().hash(hobbyOverrides),const DeepCollectionEquality().hash(languageOverrides),const DeepCollectionEquality().hash(educationQualificationOverrides),const DeepCollectionEquality().hash(educationGradeOverrides),translatedTo,targetJobDescription,updatedAt]);

@override
String toString() {
  return 'CvDraft(schemaVersion: $schemaVersion, id: $id, name: $name, templateId: $templateId, region: $region, documentLanguage: $documentLanguage, notes: $notes, experienceIds: $experienceIds, bulletIds: $bulletIds, projectIds: $projectIds, projectBulletIds: $projectBulletIds, skillIds: $skillIds, educationIds: $educationIds, hobbyIds: $hobbyIds, languageIds: $languageIds, publicationIds: $publicationIds, publicationBulletIds: $publicationBulletIds, publicationTitleOverrides: $publicationTitleOverrides, publicationCitationOverrides: $publicationCitationOverrides, educationBulletIds: $educationBulletIds, omittedFields: $omittedFields, hiddenSections: $hiddenSections, sectionOrder: $sectionOrder, tailoredSummary: $tailoredSummary, bulletOverrides: $bulletOverrides, headlineOverride: $headlineOverride, hideHeadline: $hideHeadline, referencesOverride: $referencesOverride, workAuthorizationOverride: $workAuthorizationOverride, hideWorkAuthorization: $hideWorkAuthorization, educationDetailsOverrides: $educationDetailsOverrides, roleOverrides: $roleOverrides, projectTitleOverrides: $projectTitleOverrides, experienceLocationOverrides: $experienceLocationOverrides, educationLocationOverrides: $educationLocationOverrides, skillLabelOverrides: $skillLabelOverrides, skillCategoryNameOverrides: $skillCategoryNameOverrides, hobbyOverrides: $hobbyOverrides, languageOverrides: $languageOverrides, educationQualificationOverrides: $educationQualificationOverrides, educationGradeOverrides: $educationGradeOverrides, translatedTo: $translatedTo, targetJobDescription: $targetJobDescription, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 int schemaVersion, String id, String name, String templateId, RegionProfile region, DocumentLanguage documentLanguage, String notes, List<String> experienceIds, Map<String, List<String>> bulletIds, List<String> projectIds, Map<String, List<String>> projectBulletIds, List<String> skillIds, List<String> educationIds, List<String> hobbyIds, List<String> languageIds, List<String> publicationIds, Map<String, List<String>> publicationBulletIds, Map<String, String> publicationTitleOverrides, Map<String, String> publicationCitationOverrides, Map<String, List<String>> educationBulletIds, Map<DraftOmittableField, List<String>> omittedFields, Set<CvSectionType> hiddenSections, List<CvSectionType> sectionOrder, String? tailoredSummary, Map<String, String> bulletOverrides, String? headlineOverride, bool hideHeadline, String? referencesOverride, String? workAuthorizationOverride, bool hideWorkAuthorization, Map<String, String> educationDetailsOverrides, Map<String, String> roleOverrides, Map<String, String> projectTitleOverrides, Map<String, String> experienceLocationOverrides, Map<String, String> educationLocationOverrides, Map<String, String> skillLabelOverrides, Map<String, String> skillCategoryNameOverrides, Map<String, String> hobbyOverrides, Map<String, String> languageOverrides, Map<String, String> educationQualificationOverrides, Map<String, String> educationGradeOverrides, DocumentLanguage? translatedTo, String? targetJobDescription, DateTime updatedAt
});
...
/// Create a copy of CvDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? schemaVersion = null,Object? id = null,Object? name = null,Object? templateId = null,Object? region = null,Object? documentLanguage = null,Object? notes = null,Object? experienceIds = null,Object? bulletIds = null,Object? projectIds = null,Object? projectBulletIds = null,Object? skillIds = null,Object? educationIds = null,Object? hobbyIds = null,Object? languageIds = null,Object? publicationIds = null,Object? publicationBulletIds = null,Object? publicationTitleOverrides = null,Object? publicationCitationOverrides = null,Object? educationBulletIds = null,Object? omittedFields = null,Object? hiddenSections = null,Object? sectionOrder = null,Object? tailoredSummary = freezed,Object? bulletOverrides = null,Object? headlineOverride = freezed,Object? hideHeadline = null,Object? referencesOverride = freezed,Object? workAuthorizationOverride = freezed,Object? hideWorkAuthorization = null,Object? educationDetailsOverrides = null,Object? roleOverrides = null,Object? projectTitleOverrides = null,Object? experienceLocationOverrides = null,Object? educationLocationOverrides = null,Object? skillLabelOverrides = null,Object? skillCategoryNameOverrides = null,Object? hobbyOverrides = null,Object? languageOverrides = null,Object? educationQualificationOverrides = null,Object? educationGradeOverrides = null,Object? translatedTo = freezed,Object? targetJobDescription = freezed,Object? updatedAt = null,}) {
...
as List<String>,languageIds: null == languageIds ? _self.languageIds : languageIds // ignore: cast_nullable_to_non_nullable
...
as String?,workAuthorizationOverride: freezed == workAuthorizationOverride ? _self.workAuthorizationOverride : workAuthorizationOverride // ignore: cast_nullable_to_non_nullable
as String?,hideWorkAuthorization: null == hideWorkAuthorization ? _self.hideWorkAuthorization : hideWorkAuthorization // ignore: cast_nullable_to_non_nullable
as bool,educationDetailsOverrides: null == educationDetailsOverrides ? _self.educationDetailsOverrides : educationDetailsOverrides // ignore: cast_nullable_to_non_nullable
...
as Map<String, String>,languageOverrides: null == languageOverrides ? _self.languageOverrides : languageOverrides // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _CvDraft() when $default != null:
return $default(_that.schemaVersion,_that.id,_that.name,_that.templateId,_that.region,_that.documentLanguage,_that.notes,_that.experienceIds,_that.bulletIds,_that.projectIds,_that.projectBulletIds,_that.skillIds,_that.educationIds,_that.hobbyIds,_that.languageIds,_that.publicationIds,_that.publicationBulletIds,_that.publicationTitleOverrides,_that.publicationCitationOverrides,_that.educationBulletIds,_that.omittedFields,_that.hiddenSections,_that.sectionOrder,_that.tailoredSummary,_that.bulletOverrides,_that.headlineOverride,_that.hideHeadline,_that.referencesOverride,_that.workAuthorizationOverride,_that.hideWorkAuthorization,_that.educationDetailsOverrides,_that.roleOverrides,_that.projectTitleOverrides,_that.experienceLocationOverrides,_that.educationLocationOverrides,_that.skillLabelOverrides,_that.skillCategoryNameOverrides,_that.hobbyOverrides,_that.languageOverrides,_that.educationQualificationOverrides,_that.educationGradeOverrides,_that.translatedTo,_that.targetJobDescription,_that.updatedAt);case _:
  return orElse();
...
class _CvDraft implements CvDraft {
  const _CvDraft({required this.schemaVersion, required this.id, required this.name, required this.templateId, this.region = RegionProfile.uk, this.documentLanguage = DocumentLanguage.enGb, this.notes = '', final  List<String> experienceIds = const <String>[], final  Map<String, List<String>> bulletIds = const <String, List<String>>{}, final  List<String> projectIds = const <String>[], final  Map<String, List<String>> projectBulletIds = const <String, List<String>>{}, final  List<String> skillIds = const <String>[], final  List<String> educationIds = const <String>[], final  List<String> hobbyIds = const <String>[], final  List<String> languageIds = const <String>[], final  List<String> publicationIds = const <String>[], final  Map<String, List<String>> publicationBulletIds = const <String, List<String>>{}, final  Map<String, String> publicationTitleOverrides = const <String, String>{}, final  Map<String, String> publicationCitationOverrides = const <String, String>{}, final  Map<String, List<String>> educationBulletIds = const <String, List<String>>{}, final  Map<DraftOmittableField, List<String>> omittedFields = const <DraftOmittableField, List<String>>{}, final  Set<CvSectionType> hiddenSections = const <CvSectionType>{}, final  List<CvSectionType> sectionOrder = const <CvSectionType>[CvSectionType.summary, CvSectionType.skills, CvSectionType.languages, CvSectionType.experience, CvSectionType.projects, CvSectionType.education, CvSectionType.hobbies, CvSectionType.references, CvSectionType.publications], this.tailoredSummary, final  Map<String, String> bulletOverrides = const <String, String>{}, this.headlineOverride, this.hideHeadline = false, this.referencesOverride, this.workAuthorizationOverride, this.hideWorkAuthorization = false, final  Map<String, String> educationDetailsOverrides = const <String, String>{}, final  Map<String, String> roleOverrides = const <String, String>{}, final  Map<String, String> projectTitleOverrides = const <String, String>{}, final  Map<String, String> experienceLocationOverrides = const <String, String>{}, final  Map<String, String> educationLocationOverrides = const <String, String>{}, final  Map<String, String> skillLabelOverrides = const <String, String>{}, final  Map<String, String> skillCategoryNameOverrides = const <String, String>{}, final  Map<String, String> hobbyOverrides = const <String, String>{}, final  Map<String, String> languageOverrides = const <String, String>{}, final  Map<String, String> educationQualificationOverrides = const <String, String>{}, final  Map<String, String> educationGradeOverrides = const <String, String>{}, this.translatedTo, this.targetJobDescription, required this.updatedAt}): _experienceIds = experienceIds,_bulletIds = bulletIds,_projectIds = projectIds,_projectBulletIds = projectBulletIds,_skillIds = skillIds,_educationIds = educationIds,_hobbyIds = hobbyIds,_languageIds = languageIds,_publicationIds = publicationIds,_publicationBulletIds = publicationBulletIds,_publicationTitleOverrides = publicationTitleOverrides,_publicationCitationOverrides = publicationCitationOverrides,_educationBulletIds = educationBulletIds,_omittedFields = omittedFields,_hiddenSections = hiddenSections,_sectionOrder = sectionOrder,_bulletOverrides = bulletOverrides,_educationDetailsOverrides = educationDetailsOverrides,_roleOverrides = roleOverrides,_projectTitleOverrides = projectTitleOverrides,_experienceLocationOverrides = experienceLocationOverrides,_educationLocationOverrides = educationLocationOverrides,_skillLabelOverrides = skillLabelOverrides,_skillCategoryNameOverrides = skillCategoryNameOverrides,_hobbyOverrides = hobbyOverrides,_languageOverrides = languageOverrides,_educationQualificationOverrides = educationQualificationOverrides,_educationGradeOverrides = educationGradeOverrides;
...
@override@JsonKey() List<String> get languageIds {
...
/// header's work-authorization line. It exists so a translated CV can
/// carry the translated sentence — the value is prose, not a code.
@override final  String? workAuthorizationOverride;
...
/// line matters on a minority of applications, so the useful state is
/// "kept in the Vault, printed only when it is relevant".
@override@JsonKey() final  bool hideWorkAuthorization;
...
/// no override: a CEFR band is a code, not wording, and reads the
/// same in every language.
 final  Map<String, String> _languageOverrides;
/// languageId -> rewritten `LanguageItem.name`. The proficiency has
/// no override: a CEFR band is a code, not wording, and reads the
/// same in every language.
@override@JsonKey() Map<String, String> get languageOverrides {
  if (_languageOverrides is EqualUnmodifiableMapView) return _languageOverrides;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_languageOverrides);
}
...
as List<String>,languageIds: null == languageIds ? _self._languageIds : languageIds // ignore: cast_nullable_to_non_nullable
...
as String?,workAuthorizationOverride: freezed == workAuthorizationOverride ? _self.workAuthorizationOverride : workAuthorizationOverride // ignore: cast_nullable_to_non_nullable
as String?,hideWorkAuthorization: null == hideWorkAuthorization ? _self.hideWorkAuthorization : hideWorkAuthorization // ignore: cast_nullable_to_non_nullable
as bool,educationDetailsOverrides: null == educationDetailsOverrides ? _self._educationDetailsOverrides : educationDetailsOverrides // ignore: cast_nullable_to_non_nullable
...
as Map<String, String>,languageOverrides: null == languageOverrides ? _self._languageOverrides : languageOverrides // ignore: cast_nullable_to_non_nullable
