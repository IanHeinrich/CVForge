...
/// carry the translated sentence — the value is prose, not a code.
 String? get workAuthorizationOverride;/// educationId -> rewritten `Education.details` text. Same
