...
mixin _$CvTranslationResult {
 ...
 String? get headline; String? get summary; String? get referencesNote; Map<String, String> get roles; Map<String, String> get projectTitles; Map<String, String> get skillCategoryNames; Map<String, String> get skillLabels; Map<String, String> get educationQualifications; Map<String, String> get educationGrades; Map<String, String> get educationDetails; Map<String, String> get hobbies; Map<String, String> get bullets;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? headline,  String? summary,  String? referencesNote,  Map<String, String> roles,  Map<String, String> projectTitles,  Map<String, String> skillCategoryNames,  Map<String, String> skillLabels,  Map<String, String> educationQualifications,  Map<String, String> educationGrades,  Map<String, String> educationDetails,  Map<String, String> hobbies,  Map<String, String> bullets)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CvTranslationResult() when $default != null:
return $default(_that.headline,_that.summary,_that.referencesNote,_that.roles,_that.projectTitles,_that.skillCategoryNames,_that.skillLabels,_that.educationQualifications,_that.educationGrades,_that.educationDetails,_that.hobbies,_that.bullets);case _:
  return orElse();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CvTranslationResult&&(identical(other.headline, headline) || other.headline == headline)&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.referencesNote, referencesNote) || other.referencesNote == referencesNote)&&const DeepCollectionEquality().equals(other._roles, _roles)&&const DeepCollectionEquality().equals(other._projectTitles, _projectTitles)&&const DeepCollectionEquality().equals(other._skillCategoryNames, _skillCategoryNames)&&const DeepCollectionEquality().equals(other._skillLabels, _skillLabels)&&const DeepCollectionEquality().equals(other._educationQualifications, _educationQualifications)&&const DeepCollectionEquality().equals(other._educationGrades, _educationGrades)&&const DeepCollectionEquality().equals(other._educationDetails, _educationDetails)&&const DeepCollectionEquality().equals(other._hobbies, _hobbies)&&const DeepCollectionEquality().equals(other._bullets, _bullets));
}
