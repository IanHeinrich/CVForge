...
mixin _$Experience {
 ...
 String get id; String get role; String get company; String get location; YearMonth get start; YearMonth? get end; bool get isCurrent; List<ExperienceBullet> get bullets;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Experience&&(identical(other.id, id) || other.id == id)&&(identical(other.role, role) || other.role == role)&&(identical(other.company, company) || other.company == company)&&(identical(other.location, location) || other.location == location)&&(identical(other.start, start) || other.start == start)&&(identical(other.end, end) || other.end == end)&&(identical(other.isCurrent, isCurrent) || other.isCurrent == isCurrent)&&const DeepCollectionEquality().equals(other.bullets, bullets));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,role,company,location,start,end,isCurrent,const DeepCollectionEquality().hash(bullets));

@override
String toString() {
  return 'Experience(id: $id, role: $role, company: $company, location: $location, start: $start, end: $end, isCurrent: $isCurrent, bullets: $bullets)';
}
...
@useResult
$Res call({
 String id, String role, String company, String location, YearMonth start, YearMonth? end, bool isCurrent, List<ExperienceBullet> bullets
});
...
/// Create a copy of Experience
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? role = null,Object? company = null,Object? location = null,Object? start = null,Object? end = freezed,Object? isCurrent = null,Object? bullets = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String role,  String company,  String location,  YearMonth start,  YearMonth? end,  bool isCurrent,  List<ExperienceBullet> bullets)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Experience() when $default != null:
return $default(_that.id,_that.role,_that.company,_that.location,_that.start,_that.end,_that.isCurrent,_that.bullets);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String role,  String company,  String location,  YearMonth start,  YearMonth? end,  bool isCurrent,  List<ExperienceBullet> bullets)  $default,) {final _that = this;
switch (_that) {
case _Experience():
return $default(_that.id,_that.role,_that.company,_that.location,_that.start,_that.end,_that.isCurrent,_that.bullets);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String role,  String company,  String location,  YearMonth start,  YearMonth? end,  bool isCurrent,  List<ExperienceBullet> bullets)?  $default,) {final _that = this;
switch (_that) {
case _Experience() when $default != null:
return $default(_that.id,_that.role,_that.company,_that.location,_that.start,_that.end,_that.isCurrent,_that.bullets);case _:
  return null;
...
class _Experience implements Experience {
  const _Experience({required this.id, required this.role, required this.company, required this.location, required this.start, this.end, this.isCurrent = false, final  List<ExperienceBullet> bullets = const <ExperienceBullet>[]}): _bullets = bullets;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Experience&&(identical(other.id, id) || other.id == id)&&(identical(other.role, role) || other.role == role)&&(identical(other.company, company) || other.company == company)&&(identical(other.location, location) || other.location == location)&&(identical(other.start, start) || other.start == start)&&(identical(other.end, end) || other.end == end)&&(identical(other.isCurrent, isCurrent) || other.isCurrent == isCurrent)&&const DeepCollectionEquality().equals(other._bullets, _bullets));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,role,company,location,start,end,isCurrent,const DeepCollectionEquality().hash(_bullets));
...
/// Create a copy of Experience
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? role = null,Object? company = null,Object? location = null,Object? start = null,Object? end = freezed,Object? isCurrent = null,Object? bullets = null,}) {
