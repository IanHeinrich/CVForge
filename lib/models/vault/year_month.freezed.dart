...
class _YearMonth extends YearMonth {
  const _YearMonth({required this.year, required this.month}): assert(month >= 1 && month <= 12, 'month must be between 1 and 12'),super._();
  factory _YearMonth.fromJson(Map<String, dynamic> json) => _$YearMonthFromJson(json);
