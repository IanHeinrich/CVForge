...
/// Vault/Draft index into memory, then routes to [VaultViewRoute].
///
...
/// if this View never ran. Populating a fresh draft from the Vault
/// (`DraftService.isFreshDraft`) happens in `StudioViewModel`, not here —
/// with multiple drafts it's "whichever draft you just opened", a Studio
/// concern, not an app-startup one.
