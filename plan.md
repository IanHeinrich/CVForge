...
**G7 — export error copy is one generic message for every failure mode.** Already meets the plan's bar ("surfaced visibly, never silent"); classifying failure modes is pure polish. **Deferred, not in scope for this PR — resolved 2026-08-20, see "Follow-up fixes" below.**
